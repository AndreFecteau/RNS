...
double Implicit_Marching<global_solution_vector_type, matrix_type>::timemarch(double time_frame,
  ...
  std::vector<matrix_type>    top2(global_solution_vector.size()-2);
  std::vector<matrix_type>    top(global_solution_vector.size()-2);
  std::vector<matrix_type>    bot(global_solution_vector.size()-2);
  std::vector<matrix_type>    bot2(global_solution_vector.size()-2);
...
{
#if !defined(MANUFACTURED)
  mid[global_solution_vector.size()-3] += top[global_solution_vector.size()-3] + top2[global_solution_vector.size()-3];
  top[global_solution_vector.size()-4] += top2[global_solution_vector.size()-4];
