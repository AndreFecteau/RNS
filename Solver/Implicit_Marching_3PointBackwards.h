#ifndef IMPLICIT_MARCHING_3POINTBACKWARDS_H
#define IMPLICIT_MARCHING_3POINTBACKWARDS_H
...
double Implicit_Marching<global_solution_vector_type, matrix_type>::timemarch(double time_frame, global_solution_vector_type &global_solution_vector, double Lambda) {
  ...
  global_solution_vector_type delta_global_solution_vector_past;
  // CFL *= 1.01;
  // std::cout << "CFL:" << CFL << std::endl;

  bool initialize_check = 0;
#pragma omp parallel
  {
  residual = 10000000.0;
...
//       delta_global_solution_vector_past = delta_global_solution_vector;
//       initialize_check = 1;
//     }

// #pragma omp single
// std::cout << rhs.size() << " : " << delta_global_solution_vector_past.size() << std::endl;
#pragma omp single
for (int i = 0; i < delta_global_solution_vector_past.size(); ++i) {
rhs[i] += 0.5/1.5*delta_global_solution_vector_past[i];
}
...
#endif //#ifndef IMPLICIT_MARCHING_3POINTBACKWARDS_H
