...
template <typename scalar_type>
scalar_type RK4_High_Mach_Solver<scalar_type>::dudx_(scalar_type, scalar_type Theta_, scalar_type U_, scalar_type, scalar_type) {
  return 0.75/(Pr*gamma*mf*mf)*(Theta_/U_-1+gamma*mf*mf*(U_-1));
}

template <typename scalar_type>
scalar_type RK4_High_Mach_Solver<scalar_type>::dThetadx_(scalar_type, scalar_type Theta_, scalar_type U_, scalar_type dYdx_, scalar_type Y_) {
  return -1.0/Le*dYdx_+(gamma-1)/gamma*(U_-Theta_-gamma*mf*mf/2.0*(U_-1)*(U_-1))+Theta_-1+Y_-Y1();
}
template <typename scalar_type>
scalar_type RK4_High_Mach_Solver<scalar_type>::ddyddx_(scalar_type, scalar_type Theta_, scalar_type U_, scalar_type dYdx_, scalar_type Y_) {
