...
plot \
"./Movie/Delete_400.dat"      using ($1):4    title "_D500" with lines ,\
"./Movie/Delete_401.dat"      using ($1):4    title "_D500" with lines ,\
"./Movie/Delete_402.dat"      using ($1):4    title "_D500" with lines ,\
